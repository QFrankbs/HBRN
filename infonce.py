...
class InfoNCE(nn.Module):
    ...
    def __init__(self, hp, temperature=0.1, reduction='mean', negative_mode='paired'):
        super().__init__()
        self.temperature = temperature
        self.reduction = reduction
        self.negative_mode = negative_mode
        self.orig_d_l = 3*hp.hidden_size
        self.orig_d_av = hp.audio_feat_size
        self.d_l, self.d_av = 3*hp.hidden_size, hp.audio_feat_size ### 50, 50, 30, 30
